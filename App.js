...
import CurrentSubCategory from './pages/CurrentSubCategory';
import CurrentCategory from './pages/CurrentCategory';
import ClientComplaintList from './pages/ClientComplaintList';
import CurrentPendingComplaints from './pages/CurrentPendingComplaints';
import UpdateComplaint from './pages/UpdateComplaint';
import ComplaintProfile from './pages/ComplaintProfile';
import CurrentCompletedComplaints from './pages/CurrentCompletedComplaints';
...
<Stack.Screen 
  ...
  <Stack.Screen
   ...
   options={{...myOptions1,title:" UnBlocked Employee Profile"}} 
    />
      <Stack.Screen
...
<Stack.Screen
    ...
    options={{...myOptions,title:" Current SubCategory"}} 
     />
...
<Stack.Screen
    ...
    options={{...myOptions,title:" Current Category"}} 
     />

    
<Stack.Screen
    name="ClientComplaintList"
    component={ClientComplaintList}
    options={{...myOptions,title:" Client Complaint List "}} 
     />

<Stack.Screen
    name="CurrentPendingComplaints"
    component={CurrentPendingComplaints}
    options={{...myOptions,title:" Current Pending Complaints "}} 
     />
     
<Stack.Screen
    name="UpdateComplaint"
    component={UpdateComplaint}
    options={{...myOptions,title:"Update Complaint "}} 
     />
...
<Stack.Screen
    ...
    options={{...myOptions,title:"Complaint Profile "}} 
     />


<Stack.Screen
    name="CurrentCompletedComplaints"
    component={CurrentCompletedComplaints}
    options={{...myOptions,title:"Completed Complaint Profile "}} 
     />
     
<Stack.Screen
    name="ComplaintDashboard"
    component={ComplaintDashboard}
    options={{...myOptions,title:"Complaint Dashboard "}} 
     />
