...
const ComplaintProfile = (props)=>{

   const {_id,serviceTitle,dateCreated,remarks,status,vendorName,description,image} = props.route.params.item
             ...
             {_id,remarks,status}
                      ...
                      <View style={{
                          ...
                          marginTop:20
                                     ...
                                     <TouchableOpacity  onPress={() =>  {
          props.navigation.navigate("ClientComplaintList",
